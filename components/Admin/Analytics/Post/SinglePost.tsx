...
export const columns: ColumnDef<SinglePostAnalytics>[] = [
  {
    accessorKey: "title",
    header: ({ column }) => {
      return (
...
export default function SinglePost({ posts }: Posts) {
  const [data, setData] = useState<SinglePostAnalytics[]>([]);
